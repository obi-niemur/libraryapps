...
<title>Librarian Register Here</title>
</head>
<body>

	<h1 class="Registration-title">Registration Form for Librarian</h1>


	<form action="librarian_process.jsp" method="post">
		<div class="container">
		...
		<div class="container signin">
			<p>
				Already have an account? <a href="../login pages/librarian_login.jsp">Sign in</a>.
			</p>
		</div>
	</form>
