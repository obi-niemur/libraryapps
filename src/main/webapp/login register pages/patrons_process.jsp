...
try{
	...
	if(password.equals(confrmPassword)){
		...
		int i = st.executeUpdate("insert into patrons(userName,firstName,lastName,password)values('"+username+"','"+firstName+"','"+lastName+"','"+password+"')");
		out.println("form is submitted");
		 
		 response.sendRedirect("../login pages/patrons_login.jsp");
